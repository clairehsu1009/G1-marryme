...
CREATE TABLE plan_product (
  ...
  plan_product_status int comment'商品狀態,0下架、1上架、2預定額滿',
...
INSERT INTO plan_product (vendor_id, plan_title, plan_introduction, plan_product_status, update_time)
VALUES
('vendor1@gmail.com', '台北韓系小桌數專案', '水水新娘，妳能擁有的網美級場地，跟神助手婚企團隊，免另外找廠商，也可以享受超美的婚禮佈置，跟專業婚禮主持人', '0', NOW()),
('vendor1@gmail.com', '戶外｜室內證婚儀式', '屬於你的網美證婚場地#戶外高空證婚 #室內網美證婚給你滿滿的儀式感，讓婚禮每一張照片都美到想狂發IG', '0', NOW()),
('vendor1@gmail.com', '日日好婚日', '2023女神成家｜囍上加囍，+1好幸福', '0', NOW()),
('vendor2@gmail.com', '2023 輕鬆成家 微婚禮🤍超幸福', '【2023小桌數婚宴專案】', '0', NOW()),
('vendor2@gmail.com', '夢幻婚禮方案', '♥ 婚禮服務內容 ♥\n婚禮主持及流程規劃(45天前)\n新娘專屬管家服務\n現場宴會督導及流程掌控\n優質婚禮廠商推薦', '0', NOW()),
('vendor2@gmail.com', '戶外證婚專案', '★儀式備品提供★\n．甜茶6-12人份、湯圓6-12人份、雞腿1隻、傳統高低椅一組、聘禮桌', '0', NOW());
...
('vendor1@gmail.com', 1, '豪華澎拜甲吼飽飽飽', '一桌的價格', 8000, 20000, 0, 0),
('vendor1@gmail.com', 2, '基本企劃', '簡易流程規劃', 40000, 100000, 0, 0),
('vendor1@gmail.com', 2, '豪華浪漫企劃', '豪華浪漫企劃從頭到尾幫你包辦', 80000, 200000, 0, 0),
('vendor1@gmail.com', 3, '花草主題', '大自然的元素', 6400, 16000, 0, 0),
('vendor1@gmail.com', 3, '仙女風格', '看過住城堡的公主嗎？', 12800, 32000, 0, 0),
('vendor1@gmail.com', 3, '貴氣逼人', '奢華程度史上第一，後無來者', 80000, 200000, 0, 0),
...
CREATE TABLE plan_product_detail (
    ...
    plan_product_id int not null comment'方案商品_ID',
