...
<aside class="app-sidebar">
    ...
    <ul class="app-menu">
        <li><a class="app-menu__item" href="${pageContext.request.contextPath}/Index"><i
                class="app-menu__icon fa fa-shopping-bag"></i><span class="app-menu__label">首頁</span></a></li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                class="app-menu__icon fa fa-shopping-bag"></i><span class="app-menu__label">使用者資料管理</span><i
                class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="${pageContext.request.contextPath}/user/userMaterial"><i class="icon fa fa-archive"></i>會員資料列表</a></li>
                <li><a class="treeview-item" href="${pageContext.request.contextPath}/vendor/vendorMaterial"><i class="icon fa fa-edit"></i>廠商資料列表</a></li>
                <li><a class="treeview-item" href="${pageContext.request.contextPath}/emp/empMaterial"><i class="icon fa fa-edit"></i>員工資料列表</a></li>
            </ul>
        </li>
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
