...
<link
	href="https://statics.marry.com.tw/pop-venue_reserve_form-20230706001.css"
...
<body>
	...
	<div id="pop">
		<div class="pop-casemain radius_3">
			...
			<h3 class="title_center">
				預約賞廳 <a class="close" href="javascript:void('0');"
					onclick="destroyObj();tb_remove();">X</a>
			</h3>
			<div id="reserve_form" class="pop-casemain-inner">
				<div class="form_wrap">
					...
					<a class="venueInfo" target="_blank" href="跳轉到場商頁面"><span
						class="venueInfo_pic"> <img
					...
					<form id="venueReserve_form" class="venueReserve_form">
						...
						<span><i>*</i>廠商</span> 
							...
							<input class="form_input input_code" type="text" value="vendor9@gmail.com" name="vendor_id" id="vendor_id" placeholder="廠商ID" autocomplete="off"> 
						
						<span><i>*</i>會員</span> 
							<span class="sattus" style="display: none;"></span> 
							<input class="form_input input_code" type="text" value="member8@gmail.com" name="member_id" id="member_id" placeholder="會員ID" autocomplete="off"> 
						
						<span><i>*</i>預約大名</span> 
							<span class="sattus" style="display: none;"></span> 
							<input class="form_input input_code" type="text" value="KEN" name="contact_name" id="contact_name" placeholder="輸入名字" autocomplete="off"> 
						
						<span><i>*</i>聯絡電話</span> 
							<span class="sattus" style="display: none;"></span> 
							<input class="form_input input_code" type="text" value="0912345678" name="contact_number" id="contact_number" placeholder="輸入電話" autocomplete="off" maxlength="10">

						<div class="form_wrap_half">
							<span>宴客日期</span> 
							<span class="sattus" style="display: none;"></span> 
							<input class="form_input input_code datepicker hasDatepicker" rel_status="2" type="date" value="" placeholder="預計婚期" id="event_date" name="event_date" autocomplete="off">
						</div>
						
						<div class="form_wrap_half">
							<span> <i>*</i>宴客時段
							</span> <span class="sattus" style="display: none;"></span> <select
								class="form_select input_code" id="event_hi"
								name="event_hi">
						...
						<div class="form_wrap_half">
							<span> <i>*</i>預約日期 </span> 
							<span class="sattus" style="display: none;"></span> 
							<input class="form_input m_r_8 input_code form_select datepicker hasDatepicker" type="date" value="" placeholder="選擇預約日期" id="reservation_date" name="reservation_date" autocomplete="off">
						</div>

						<div class="form_wrap_half">
							<span> <i>*</i>預約時段
							</span> <span class="sattus" style="display: none;"></span> <select
								class="form_select input_code" id="reservation_hi"
								name="reservation_hi">
								<option value="">選擇預約時段</option>
						...
						<span>備註</span>
						<textarea class="form_input input_note" type="text"
							name="reservation_notes" id="reservation_notes"
							placeholder="其他事項" autocomplete="off"></textarea>
				...
				<div class="btnArea">
					<a class="submitBtn data-g-reserve-pop-form-send"
						href="javascript:;" id="submitReservation">確認送出 </a>
				</div>
			</div>
		</div>
	</div>
	...
	btnArea.addEventListener('click', function(event) {
	    ...
	    // 将日期和时间合并为完整的值
	    var eventDate = eventDateO + " " + eventTime;
