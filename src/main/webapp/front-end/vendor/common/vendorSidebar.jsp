    ...
    <ul class="app-menu">
        ...
        <li class="treeview"><a class="app-menu__item" href="#"  data-toggle="treeview"><i
            ...
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="<%=request.getContextPath()%>/product/findAll?vendorId=${vendorId}"><i class="icon fa fa-archive"></i>我的商品</a></li>
        ...
        <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i
                ...
                class="treeview-indicator fa fa-angle-right"></i></a>
            <ul class="treeview-menu">
                <li><a class="treeview-item" href="<%=request.getContextPath()%>/plan?vendorId=${vendorId}"><i class="icon fa fa-archive"></i>我的方案</a></li>
