...
<jsp:useBean id="errorMsgMap" scope="request" type="java.util.HashMap"/>
		...
		<div class="row">
			<div class="col-md-12 productsAdd">
				<FORM METHOD="post" ACTION="<%=request.getContextPath()%>/plan-item">
					...
					<div class="form-group">
						<c:if test="${errorMsgMap.containsKey('itemTotal')}">
							<span class="errorMsg">${errorMsgMap['itemTotal']}</span>
						</c:if>
