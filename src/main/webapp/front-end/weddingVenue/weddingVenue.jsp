			...
			<section class="rwd_wrap group">
				<div id="service_filter_obt_html">
					<dl id="show_pr" class="show_filter">
						<dt>
							<a href="${pageContext.request.contextPath}/weddingPlanList" onclick="check_open_filter('show_pr');">
								方案 </a>
						</dt>
				...
				<div id="service_filter_ts_html">
					<dl id="show_pr" class="show_filter">
						<dt>
							<a style="color: hsla(0, 100%, 50%, 0.5);" href="${pageContext.request.contextPath}/weddingVenueList" onclick="check_open_filter('show_pr');">
								場地 </a>
						</dt>
					</dl>				
				</div>
